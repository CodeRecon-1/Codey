from tools.base import FileDiff,Tool, Toolkind,ToolInvocation,ToolConiformation,ToolResult
...
class EditTool(Tool):
    ...
    async def get_confirmation(self, invocation) -> ToolConiformation|None:
