...
def get_config_dir() -> Path:
    #automatically finds the correct, "standard" location for your application's configuration files based on the operating system. 
    return Path(user_config_dir("Codey"))


def get_data_dir() -> Path:
    return Path(user_data_dir("Codey"))
