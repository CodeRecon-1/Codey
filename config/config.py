...
class Config(BaseModel):
    ...
    max_turns: int = 100
    max_tool_output_token:int = 50000
    ...
    def api_key(self) -> str | None:
        return os.environ.get("API_KEY")#trying to get api key from environment variables

    @property
    def base_url(self) -> str | None:
        return os.environ.get("BASE_URL")

    @property#instead of self.model.name do self.model_name(for convinience)
    def model_name(self) -> str:
        return self.model.name

    @model_name.setter#config.model_name = ...
    ...
    @model_name.setter#should exist property model_temperature
