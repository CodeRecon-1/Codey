...
def truncate_text(
    ...
    else: return _truncate_by_chars(text, target_tokens, suffix, model)
...
def truncate_by_lines(
    ...
    if not result_lines:
        return truncate_by_chars(text, target_tokens, suffix, model)    
    ...
    def truncate_by_chars(
       ...
       """ Truncate text by character count estimation"""
